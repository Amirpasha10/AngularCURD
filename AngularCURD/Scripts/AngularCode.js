...
app.controller("myCtrl", function ($scope, $http) {
    ...
    $scope.InsertData = function () {
        ...
        if (Action == "Submit") {
            ...
            $http({
                method: "post",
                url: "http://localhost:50975/Employee/Insert_Employee",
                datatype: "json",
            ...
            $http({
                method: "post",
                url: "http://localhost:50975/Employee/Update_Employee",
                datatype: "json",
                data: JSON.stringify($scope.Employe)
            }).then(function (response) {
                alert(response.data);
    ...
    $scope.GetAllData = function () {
        $http({
            method: "get",
            url: "http://localhost:50975/Employee/Get_AllEmployee"
        }).then(function (response) {
    ...
    $scope.DeleteEmp = function (Emp) {
        $http({
            method: "post",
            url: "http://localhost:50975/Employee/Delete_Employee",
            datatype: "json",
